...
const InvitationView: React.FC<Props> = ({ data }) => {
  return (
    <div className="max-w-screen-sm mx-auto bg-white shadow-xl min-h-screen pb-20 overflow-x-hidden">
      <MainVisual data={data} />
      <GreetingSection greeting={data.greeting} groom={data.groom} bride={data.bride} />
